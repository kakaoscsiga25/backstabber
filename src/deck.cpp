...
Deck::Deck()
{
    ...
    door_deck.push_back(new CardMonster(Monster("1lvl monster", 1, 1)));
    door_deck.push_back(new CardMonster(Monster("5lvl monster", 5, 1)));
    door_deck.push_back(new CardMonster(Monster("10lvl monster", 10, 2)));
    door_deck.push_back(new CardMonster(Monster("20lvl monster", 20, 4)));
